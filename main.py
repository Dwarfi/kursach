...
# Place
# name_of_place,longitude,latitude,category,description
...
G_MAPS_URL = "https://www.google.com/maps/dir/49.84475968896546+23.996881888607582/"
...
route1 = 'chosen_route_Route_1'
route2 = 'chosen_route_Route_2'
route3 = 'chosen_route_Route_3'


@bot.callback_query_handler(lambda call: call.data == 'chosen_route_Route_1')
def sendroute1(call):
    bot.send_message(call.message.chat.id, get_direction(routes["Route_1"],call.message))
@bot.callback_query_handler(lambda call: call.data == 'chosen_route_Route_2')
def sendroute2(call):
    bot.send_message(call.message.chat.id, get_direction(routes["Route_2"],call.message))

@bot.callback_query_handler(lambda call: call.data == 'chosen_route_Route_3')
def sendroute3(call):
    bot.send_message(call.message.chat.id, get_direction(routes["Route_3"],call.message))
